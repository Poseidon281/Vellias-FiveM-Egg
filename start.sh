...
echo -e "${GREEN} This server is provived to you by Vellias Hosting ${NC}"
echo -e "${RED} Website: https://velliashosting.online ${NC}"
echo -e "${RED} Support: https://discord.velliashosting.online ${NC}"
